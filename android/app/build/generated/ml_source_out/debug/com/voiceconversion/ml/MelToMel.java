package com.voiceconversion.ml;
...
public final class MelToMel {
  @NonNull
  private final Model model;

  private MelToMel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "mel_to_mel.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static MelToMel newInstance(@NonNull Context context) throws IOException {
    return new MelToMel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static MelToMel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new MelToMel(context, options);
  }
